...
def blockchain_three_blocks():
    ...
    # add 3 arbitrary blocks to the blockchain instance
    for i in range(3):
...
def test_is_valid_transaction_chain_multiple_rewards(blockchain_three_blocks):
    reward_1 = Transaction.reward_tansaction(Wallet()).to_json()
    reward_2 = Transaction.reward_tansaction(Wallet()).to_json()
...
def test_is_valid_transaction_chain_bad_transaction(blockchain_three_blocks):
    bad_transaction = Transaction(Wallet(), 'recipient', 1).to_json()
