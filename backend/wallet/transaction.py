...
class Transaction:
    """
    Document of exchange in currency from a sender 
    ...
    def create_output(self, sender_wallet, recipient, amount):
        ...
        output[sender_wallet.address] = sender_wallet.balance - amount # change for the sender
    ...
    def update(self, sender_wallet, recipient, amount):
        """
        Update the transaction with an existing or a new recipient
        """
    ...
    def from_json(transaction_json):
        """
        Deserialize a transaction's json representation
        back into a Transaction instance.
        """
    ...
    @staticmethod
    def reward_tansaction(miner_wallet):
        """
